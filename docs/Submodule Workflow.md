...
| `tg-3.6` | Godot 3.6-based renderer for gates declaring `godot_version = "3.6"`. Based on upstream 3.6.3 with the module and thirdparty in-tree; see [[Godot 3 Renderer]]. |
